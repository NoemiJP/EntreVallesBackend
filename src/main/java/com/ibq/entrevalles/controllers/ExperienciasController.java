...
public class ExperienciasController {
	...
	public @ResponseBody List<Experiencia> prueba(@RequestBody ExperienciasFiltros experienciasFiltros) {
		List<Experiencia> experiencias = this.experienciasRepository.filterWithFirstImage(experienciasFiltros.getLocalizacion(),
				experienciasFiltros.getAlojamiento(), experienciasFiltros.getEquipamiento());
	...
	@GetMapping("/buscador")
	public @ResponseBody List<Experiencia> experienciasNoReservadas(@RequestParam("fechaInicio") Date fechaInicio,
